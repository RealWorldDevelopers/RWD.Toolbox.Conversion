...
```bash
git clone https://github.com/RealWorldDevelopers/RWD.Toolbox.Conversion.git
cd RWD.Toolbox.Conversion
````
...
```bash
git remote add upstream https://github.com/RealWorldDevelopers/RWD.Toolbox.Conversion.git
git remote -v
```
